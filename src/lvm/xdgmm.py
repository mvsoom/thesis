...
class GMMFit:
    K: int
    params: GMMParams
    mu0: jnp.ndarray  # (d,) background component mean
    cov0: jnp.ndarray  # (d,d) background component covariance

    r: jnp.ndarray  # (N, K+1) responsibilities
    pi_bg: jnp.ndarray  # (K+1,) mixture weights including background
    pi: jnp.ndarray  # (K,) mixture weights excluding background
...
def fit_xdgmm(
    ...
    r, *_ = e_step(m, S, params, mu0, cov0, jitter=jitter)
