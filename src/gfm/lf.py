...
def lf_relaxation_open_phase(Rd, tc, N, eps=1e-5):
    ...
    The LF waveform is cut off at the point where the cumulative flow U reaches 1 - eps, because for small Rd the effective GCI is way lower than tc. eps was chosen for a good balance across the Rd range.
