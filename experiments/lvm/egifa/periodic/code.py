...
from prism.harmonic import SHMCollapsedVariationalGaussian, SHMPeriodic
...
def collapsed_svi(key=vk(), M=M):
    kernel = SHMPeriodic(variance=1.0, lengthscale=1.0, period=1.0)
